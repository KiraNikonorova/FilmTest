...
public class FragmentDetective extends Fragment {


    private ArrayList<Film> filmList;
    private FragmentTransaction fTrans;
    private FilmAdapter fAdapter = new FilmAdapter(new ArrayList<Film>());

    public FragmentDetective(ArrayList<Film> listFilm){
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState){
        ...
        RecyclerView recyclerView = (RecyclerView) inflater.inflate(R.layout.fragment_detective, container, false);
